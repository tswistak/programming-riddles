...
type GetCount<Count extends number, Elements, Query extends string> =
    Elements extends [infer First, ...infer Rest] ? 
        First extends Query ? GetCount<GetNext<Count>, Rest, Query> : GetCount<Count, Rest, Query>
    : Count;

type Count<Elements extends string[], Query extends string> = GetCount<0, Elements, Query>;
